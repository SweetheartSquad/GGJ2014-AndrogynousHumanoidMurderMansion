					...
					if (containsInt(tiles[i-1], 0) && containsInt(tiles[i-2],0))
					{
						if (Std.random(10) > 3)
						{
							...
							doors.add(new Teleporter(
								...
								Std.random(Reg.gameWidth - 256)+200,
								(i * 16 - 30),
								DOOR,
								...
								var doorTwoRandX:Int = Std.random(Reg.gameWidth - 256) + 200;
								...
								{
									doorTwoRandX = Std.random(Reg.gameWidth - 256) + 200;
								}
					...
					if (containsInt(tiles[i-1], 0) && containsInt(tiles[i-2],0) && !containsInt(tiles[i+1],1))
					{
						if (Std.random(10) > 3)
						{
							...
							doors.add(new Teleporter(
								...
								var doorsTwoRandX:Int = Std.random(Reg.gameWidth - 256) + 200;
								while (!(doorsTwoRandX < ((cast(doors._members[doors._members.length-1],Teleporter).x)+60))&& !(doorsTwoRandX > ((cast(doors._members[doors._members.length-1],Teleporter).x)-40)))
								{
									doorsTwoRandX = Std.random(Reg.gameWidth - 256) + 200;
								}
